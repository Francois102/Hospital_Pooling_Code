...
• Purpose: Helper functions for facility data processing (Prepares facility-level hospital 
data for the temporal clustering and health effects analyses by calculating what proportion 
of each HSA's population each hospital serves)
...
--------------------------------
Figure1_regression.png/svg         - Regression results (max ICU vs population)
Figure2_volatility.png/svg         - Volatility analysis and power laws
Figure3_temporal_clustering.png/svg - Temporal clustering and pooling benefits
Figure4_health_effects.png/svg     - Health effects heatmap
